...
install.packages(c('ade4', 'akima', 'archive', 'attachment', 'bib2df', 'clisymbols', 'cronR', 'DT', 'dygraphs', 'flextable', 'ggmap', 'ggplotify', 'ggrepel', 'gitcreds', 'gt', 'gtExtras', 'gtsummary', 'janitor', 'kableExtra', 'logr', 'markdown', 'osmdata', 'palmerpenguins', 'pander', 'qrcode', 'RCurl', 'recipes', 'renv', 'RSQLite', 'sassy', 'shiny', 'shinyauthr', 'shinydashboard', 'shinyFiles', 'styler', 'svglite', 'tidygeocoder', 'tidylog', 'tidyxl'))
```
