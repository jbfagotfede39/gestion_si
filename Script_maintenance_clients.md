...
pak::pkg_install(c('ade4', 'akima', 'archive', 'attachment', 'basemaps', 'bib2df', 'bookdown', 'strboul/caseconverter', 'checkmate', 'cli', 'clisymbols', 'colourpicker', 'corrplot', 'corrr', 'cronR', 'curl', 'dichromat', 'DT', 'dygraphs', 'ellmer', 'elevatr', 'emayili', 'eponge', 'esquisse', 'flextable', 'ggmap', 'ggplotify', 'ggpubr', 'ggrepel', 'ggsci', 'oswaldosantos/ggsn', 'ggthemes', 'gitcreds', 'gt', 'gtExtras', 'gtsummary', 'hexView', 'hms', 'hrbrthemes', 'htmlTable', 'httr2', 'janitor', 'kableExtra', 'leaflet', 'logr', 'magick', 'mapview', 'marquee', 'metR', 'OpenStreetMap', 'openxlsx2', 'osmdata', 'ows4R', 'paletteer', 'palmerpenguins', 'pander', 'pdftools', 'pgirmess', 'plotly', 'plumber', 'qrcode', 'readODS', 'recipes', 'RCurl', 'RefManageR', 'renv', 'reticulate', 'rosm', 'roxygen2md', 'rsconnect', 'RSQLite', 'sassy', 'shiny', 'shinyauthr', 'shinybusy', 'shinydashboard', 'shinyFiles', 'shinyjs', 'shinyTime', 'styler', 'svglite', 'tidygeocoder', 'tidylog', 'tidyxl', 'usethis', 'vegan', 'viridis', 'xfun'))
```
